...
namespace MyPortfolioWebApp.Models.DatabaseModels.DatabaseContext.Initializers
{
    public class DbInitializer : DropCreateDatabaseAlways<ApplicationDbContext>
    {
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            {
                new AboutMe() {AboutMeId = 1 ,Title = "Tytuł startowy",
            ...
            {
                new Project() { ProjectId = 1, FullDescription = "Pelen opis pierwszego projektu", ShordDescription = "krotki opis pierwszego projektu",  Title="Tytul pierwszego projektu", Commercial = true, ShowInCv = true, AuthorId = 1, DateTimeCreated = new DateTime(2016, 1, 1, 01, 01, 01), ImageLink = "/Lib/images/PlaceHolder150x150.png" },
                new Project() { ProjectId = 2, FullDescription = "Pelen opis drugiego projektu", ShordDescription = "krotki opis drugiego projektu",  Title="Tytul drugiego projektu", Commercial = false, ShowInCv = true, AuthorId = 1, DateTimeCreated = new DateTime(2017, 1, 1, 01, 01, 01), ImageLink = "/Lib/images/PlaceHolder150x150.png" },
                new Project() { ProjectId = 3, FullDescription = "Pelen opis trzeciego projektu", ShordDescription = "krotki opis trzeciego projektu",  Title="Tytul trzeciego projektu", Commercial = true, ShowInCv = false, AuthorId = 1, DateTimeCreated = new DateTime(2018, 1, 1, 01, 01, 01), ImageLink = "/Lib/images/PlaceHolder150x150.png" },
                new Project() { ProjectId = 4, FullDescription = "Pelen opis czwartego projektu", ShordDescription = "krotki opis czwartego projektu",  Title="Tytul czwartego projektu", Commercial = false, ShowInCv = false, AuthorId = 1, DateTimeCreated = new DateTime(2019, 1, 1, 01, 01, 01), ImageLink = "/Lib/images/PlaceHolder150x150.png" }
            ...
            {
                new ProjectTechnology() {ProjectTechnologyId = 1, ProjectId = 1, TechnologyId = 1},
                new ProjectTechnology() {ProjectTechnologyId = 2, ProjectId = 1, TechnologyId = 2},

                new ProjectTechnology() {ProjectTechnologyId = 3, ProjectId = 2, TechnologyId = 3},
                new ProjectTechnology() {ProjectTechnologyId = 4, ProjectId = 2, TechnologyId = 4},

                new ProjectTechnology() {ProjectTechnologyId = 5, ProjectId = 3, TechnologyId = 5},
                new ProjectTechnology() {ProjectTechnologyId = 6, ProjectId = 3, TechnologyId = 6},

                new ProjectTechnology() {ProjectTechnologyId = 7, ProjectId = 4, TechnologyId = 7},
                new ProjectTechnology() {ProjectTechnologyId = 8, ProjectId = 4, TechnologyId = 8}
              };
            projectTechnologies.ForEach(g => context.ProjectTechnologies.Add(g));
            context.SaveChanges();
